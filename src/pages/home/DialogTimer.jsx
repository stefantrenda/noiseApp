...
const DialogTimer = ({
  ...
  const handleSecondsChange = (e) => {
    setSecondsWork(e.target.value);
  };

  const handleMinutesBreakChange = (e) => {
    setMinutesBreak(e.target.value);
  };

  const handleSecondsBreakChange = (e) => {
    setSecondsBreak(e.target.value);
  };
            ...
            <div className="flex justify-between w-full items-center">
              ...
              <div className="flex justify-center items-center  bg-[#2F2C55] rounded-2xl w-20 h-6 py-0">
                <input
                  ...
                  className="w-5 text-center bg-transparent border-none text-[#D9D9D9] text-[15px]"
                  value={minutesBreak}
                  onChange={handleMinutesBreakChange}
                />
                ...
                <input
                  ...
                  className="w-5 text-center bg-transparent border-none text-[#D9D9D9] text-[15px]"
                  max="59"
                  onChange={handleSecondsBreakChange}
                />
              </div>
            </div>
            <div className="flex justify-between w-full items-center">
